defmodule Schooner.Reader do
  ...
  defp read_datum([{:complex, z, _} | rest]), do: {Value.complex(elem(z, 1), elem(z, 2)), rest}
  ...
  defp read_datum_pos([{:complex, z, pos} | rest]),
    do: {Value.complex(elem(z, 1), elem(z, 2)), {:atom, pos}, rest}
